...
const PAGE_LABEL_OVERRIDES = {
  ...
  consultas_in100: 'Consulta Individual (IN100)',
  cliente_argus: 'Cliente Argus',
  historico_consultas: 'Histórico de Consultas',
  consultas_presenca: 'Consulta Presença',
  consultas_handmais: 'Consulta Hand+',
  consultas_prata: 'Consulta Prata',
  consultas_v8: 'Consultas V8',
...
const PAGE_KEY_ALIASES = {
  ...
  consulta_in100: 'consultas_in100',
  consultas_in100: 'consultas_in100',
  consulta_presenca: 'consultas_presenca',
  consultas_presenca: 'consultas_presenca',
  consulta_handmais: 'consultas_handmais',
  consultas_handmais: 'consultas_handmais',
  consulta_prata: 'consultas_prata',
  consultas_prata: 'consultas_prata',
  consulta_v8: 'consultas_v8',
  consultas_v8: 'consultas_v8',
  users: 'usuarios',
  usuarios: 'usuarios',
  equipes: 'equipes',
  config: 'permissoes',
...
const PAGE_CATALOG_BASE = [
  ...
  { pageKey: 'consultas_in100', route: '/consultas/in100' },
  { pageKey: 'cliente_argus', route: '/consulta/cliente-argus' },
  { pageKey: 'historico_consultas', route: '/consultas/historico' },
  { pageKey: 'consultas_presenca', route: '/consultas/presenca' },
  { pageKey: 'consultas_handmais', route: '/consultas/handmais' },
  { pageKey: 'consultas_prata', route: '/consultas/prata' },
  { pageKey: 'consultas_v8', route: '/consultas/v8' },
