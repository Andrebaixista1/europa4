...
export const PAGE_ACCESS_DEFINITIONS = Object.freeze({
  ...
  consultas_in100: createDefinition('consultas_in100', '/consultas/in100', [
    'consulta_in100',
    'consulta.in100',
    'consultas.in100',
    'consultas_in100.view',
    'consulta_in100.view',
  ]),
  ...
  consultas_presenca: createDefinition('consultas_presenca', '/consultas/presenca', [
    'consulta_presenca',
    'consulta.presenca',
    'consultas.presenca',
    'consulta_presenca.view',
    'consultas_presenca.view',
  ]),
  consultas_handmais: createDefinition('consultas_handmais', '/consultas/handmais', [
    'consulta_handmais',
    'consulta.handmais',
    'consultas.handmais',
    'consulta_handmais.view',
    'consultas_handmais.view',
    'consulta_hand_plus',
    'consulta.hand+',
  ]),
  consultas_prata: createDefinition('consultas_prata', '/consultas/prata', [
    'consulta_prata',
    'consulta.prata',
    'consultas.prata',
    'consulta_prata.view',
    'consultas_prata.view',
  ]),
  consultas_v8: createDefinition('consultas_v8', '/consultas/v8', [
    'consulta_v8',
    'consulta.v8',
    'consultas.v8',
    'consulta_v8.view',
